 ...
 */
public class SecurityFragment extends ListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_security_layout, container, false);
        list = PostORM.getAllPostsByCategory(getActivity(), Categories.security);
        //
